...
VALUES
    ...
    ('Dubois', 'Florent', 'florent.dubois@example.com',
     '$2a$10$dQtD3BVqu.7vcv.PnPbLG.nO1gKB0nI7JSLBaadn94EJbmb7KVBcG',
     '0723408166', '294 Cours Emile Zola de Lyon', '1991-11-23', NULL, 'flodubois', 20, false, NULL),

    ('Dumoulin', 'Allain', 'dumoulin.allain@example.com',
    '$2a$10$dQtD3BVqu.7vcv.PnPbLG.nO1gKB0nI7JSLBaadn94EJbmb7KVBcG',
    '0723408166', '124 Cours Emile Zola de Lyon', '1990-09-23', NULL, 'dumoulinallain', 20, false, NULL);
-- Rôles
INSERT INTO role (libelle) VALUES ('USER'), ('ADMIN'), ('EMPLOYE');

-- Liens utilisateur-role
INSERT INTO utilisateur_role (utilisateur_id, role_id) VALUES (1, 1), (2, 1), (3, 3), (4, 2);
...
INSERT INTO covoiturage (
    ...
    statut, nb_place, prix_personne, utilisateur_id, voiture_id
      ...
      ('2025-07-17', '15:29:00', 'Lyon', '2025-07-17', '17:29:00', 'Grenoble', 'TERMINE', 1, 36.32, 2, 2),
      ('2025-07-18', '09:31:00', 'Lyon', '2025-07-18', '12:31:00', 'Grenoble', 'TERMINE', 1, 28.96, 1, 1),
      ...
      ('2025-07-21', '07:50:00', 'Toulouse', '2025-07-21', '09:50:00', 'Bordeaux', 'TERMINE', 2, 34.2, 1, 1),
      ...
      ('2025-07-24', '16:38:00', 'Lyon', '2025-07-24', '21:38:00', 'Paris', 'TERMINE', 1, 27.66, 2, 2),
      ('2025-07-25', '06:14:00', 'Marseille', '2025-07-25', '08:14:00', 'Nice', 'TERMINE', 1, 14.73, 2, 2),
      ('2025-07-26', '10:52:00', 'Lyon', '2025-07-26', '13:52:00', 'Grenoble', 'OUVERT', 3, 35.89, 2, 2),
      ('2025-07-27', '15:36:00', 'Lyon', '2025-07-27', '19:36:00', 'Paris', 'TERMINE', 2, 22.33, 2, 2),
      ('2025-07-28', '16:52:00', 'Marseille', '2025-07-28', '20:52:00', 'Nice', 'TERMINE', 1, 27.77, 2, 2),
      ...
      ('2025-07-31', '17:35:00', 'Lyon', '2025-07-31', '21:35:00', 'Grenoble', 'TERMINE', 2, 11.84, 2, 2),
      ('2025-08-01', '12:27:00', 'Lyon', '2025-08-01', '15:27:00', 'Paris', 'TERMINE', 2, 21.91, 1, 1),
      ('2025-08-02', '11:03:00', 'Lyon', '2025-08-02', '15:03:00', 'Grenoble', 'OUVERT', 4, 39.49, 2, 2),
      ('2025-08-03', '12:53:00', 'Lyon', '2025-08-03', '16:53:00', 'Grenoble', 'TERMINE', 2, 31.77, 1, 1),
      ...
      ('2025-08-08', '09:01:00', 'Lyon', '2025-08-08', '11:01:00', 'Paris', 'TERMINE', 1, 18.7, 2, 2),
      ('2025-08-09', '08:25:00', 'Lyon', '2025-08-09', '10:25:00', 'Paris', 'OUVERT', 4, 19.37, 1, 1),
      ('2025-08-10', '10:34:00', 'Toulouse', '2025-08-10', '13:34:00', 'Bordeaux', 'OUVERT', 1, 12.5, 2, 2),
      ('2025-08-11', '17:16:00', 'Lyon', '2025-08-11', '21:16:00', 'Paris', 'TERMINE', 1, 27.3, 1, 1),
      ('2025-08-12', '17:27:00', 'Lyon', '2025-08-12', '19:27:00', 'Grenoble', 'TERMINE', 1, 34.46, 1, 1),
